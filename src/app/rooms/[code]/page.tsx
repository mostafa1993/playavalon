...
export default function RoomPage() {
  ...
  return (
    <main className="h-screen bg-avalon-midnight flex flex-col overflow-hidden">
      {videoConnected && (
        <div className={`fixed top-6 ${isLayoutSwapped && viewMode === 'split' ? 'left-4' : 'right-4'} flex items-center gap-4 px-4 py-1.5 bg-avalon-midnight/60 backdrop-blur-md rounded-full border border-avalon-dark-border/50 z-50`}>
          <ViewModeToggle />
