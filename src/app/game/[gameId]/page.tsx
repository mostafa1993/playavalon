...
export default function GamePage() {
  ...
  return (
    <main className="h-screen bg-avalon-midnight flex flex-col overflow-hidden">
      {isConnected && (
        <div className={`fixed top-6 ${isLayoutSwapped && viewMode === 'split' ? 'left-4 origin-top-left' : 'right-4 origin-top-right'} scale-125 flex items-center gap-4 px-4 py-1.5 bg-avalon-midnight/60 backdrop-blur-md rounded-full border border-avalon-dark-border/50 z-50`}>
          <ViewModeToggle />
